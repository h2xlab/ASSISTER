...
class COCO:
    ...
    def getImgIds(self, imgIds=[], catIds=[]):
        ...
        return [str(id_) for id_ in list(ids)]
    ...
    def loadRes(self, resFile):
        ...
        if 'caption' in anns[0]:
            imgIds = set([str(img['id']) for img in res.dataset['images']]) & set([ann['image_id'] for ann in anns])
            # print(set([img['id'] for img in res.dataset['images']]), "0000000000000000000000000000000000000000000000000", set([ann['image_id'] for ann in anns]))
            # print(imgIds)
            res.dataset['images'] = [img for img in res.dataset['images'] if str(img['id']) in imgIds]
